...
export const caseStudies: CaseStudyModel[] = [
  {
    image: `${baseUrl}images/Mitjob.ai-mockup.webp`,
    number: "01",
    title: "Mitjob.ai",
    description:
  ...
  {
    image: `${baseUrl}images/Havblink-mockup.webp`,
    number: "02",
    title: "Havblink",
    description:
  ...
  {
    image: `${baseUrl}images/Aim4-mockup.webp`,
    number: "03",
    title: "AIM4",
    description:
...
export const skills: SkillModel[] = [
  {
    icon: `${baseUrl}images/hugeicons_investigation.webp`,
    name: "UX Research",
    description:
  ...
  {
    icon: `${baseUrl}images/streamline_figma.webp`,
    name: "UI Design",
    description:
  ...
  {
    icon: `${baseUrl}images/mingcute_code-line.webp`,
    name: "Frontend Dev",
    description:
  ...
  {
    icon: `${baseUrl}images/solar_database-linear.webp`,
    name: "Backend Dev",
    description:
...
export const steps: WizardStepModel[] = [
  {
    ...
    image: `${baseUrl}images/erhversakademi-arrhus.webp`,
    period: "Jan 2025 - Present",
  },
  {
    title: "Full Stack Developer intern",
    image: `${baseUrl}images/dansk socialarbejde.webp`,
    period: "Jan 2024 - Jun 2024",
  },
  {
    title: "Web development bootcamp",
    image: `${baseUrl}images/hack-your-future.webp`,
    period: "Oct 2022 - Jul 2023",
  },
  {
    title: "Adgangskursus til Ingenioruddannelse",
    image: `${baseUrl}images/aarhus uni.webp`,
    period: "Jan 2021 - Jan 2022",
  },
  {
    title: "Enkeltfag",
    image: `${baseUrl}images/vuc.webp`,
    period: "2018 - 2021",
  },
];
